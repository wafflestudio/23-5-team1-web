...
export const SearchProvider = ({ children }: { children: ReactNode }) => {
    ...
    const fetchSearchResult = useCallback(async (q: string, page: number, size: number)=>{
	...
	return (
		<SearchContext.Provider
			value={{ query, page, size, setQuery, setPage, setSize, searchResults, searchLoading, fetchSearchResult }}
		>
			{children}
		</SearchContext.Provider>
	);
