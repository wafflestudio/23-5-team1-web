    ...
    return (
        <div className={styles.toolbarContainer}>
            <div className={styles.headerRow}>
                <h2 className={styles.search}>{query ? `'${query}' 검색 결과` : '검색'}</h2>
                <div className={styles.btnGroup}>
                    <button
                        type="button"
                        className={styles.calendarBtn}
                    >
                        <FaCalendarAlt onClick={()=>navigate('/main')} size={25} color="rgba(130, 130, 130, 1)" />
                    </button>
                ...
                <div className={styles.searchBox}>
                    <div className={styles.inputWrapper}>
                        <input 
                            ...
                            onKeyDown={(e)=> {if (e.key === 'Enter') setQuery(queryState)}}
                        />
                        {queryState && (
                            <button
                                type='button'
