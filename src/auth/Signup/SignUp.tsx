...
export default function SignUp() {
    ...
    switch (method) {
        case 'email': return <EmailSignUp />;
        case 'google': return <SocialSignUp provider={method} />;
        case 'kakao': return <SocialSignUp provider={method} />;
        case 'naver': return <SocialSignUp provider={method} />;
    }
    ...
    return (
        <div>
            ...
            <div>
                <button type="submit" onClick={() => onSelect('email')}>이메일로 가입하기</button>
